...
<div class="max-w-3xl mx-auto mt-8">
    ...
    <div class="bg-gradient-to-br from-gray-900 via-blue-900 to-gray-800 
        ...
        <h1 class="text-2xl font-bold text-white mb-6 text-center">Edit Data Guru</h1>
        ...
        <form method="POST" action="{{ route('teachers.update', $teacher->id) }}" class="space-y-5">
            ...
            <div>
                ...
                <input type="text" name="nama_lengkap" id="nama_lengkap" value="{{ old('nama_lengkap', $teacher->nama_lengkap) }}"
                       class="w-full px-4 py-2 rounded-lg bg-gray-800/70 border border-gray-600 
                              focus:ring-2 focus:ring-blue-500 focus:outline-none text-white
                              hover:bg-gray-700/80 transition-all"
                       required>
            ...
            <div>
                ...
                <input type="text" name="Jabatan" id="Jabatan" value="{{ old('Jabatan', $teacher->Jabatan) }}"
                       class="w-full px-4 py-2 rounded-lg bg-gray-800/70 border border-gray-600 
                              focus:ring-2 focus:ring-blue-500 focus:outline-none text-white
                              hover:bg-gray-700/80 transition-all">
            </div>
            ...
            <div>
                ...
                <input type="text" name="no_hp" id="no_hp" value="{{ old('no_hp', $teacher->no_hp) }}"
                       class="w-full px-4 py-2 rounded-lg bg-gray-800/70 border border-gray-600 
                              focus:ring-2 focus:ring-blue-500 focus:outline-none text-white
                              hover:bg-gray-700/80 transition-all">
            </div>
            ...
            <div>
                ...
                <textarea name="Alamat" id="Alamat" rows="3"
                          class="w-full px-4 py-2 rounded-lg bg-gray-800/70 border border-gray-600 
                                 focus:ring-2 focus:ring-blue-500 focus:outline-none text-white
                                 hover:bg-gray-700/80 transition-all">{{ old('Alamat', $teacher->Alamat) }}</textarea>
            </div>
            ...
            <div>
                ...
                <select name="is_active" id="is_active"
                    ...
                    <option value="0" {{ !old('is_active', $teacher->is_active) ? 'selected' : '' }}>Tidak Aktif</option>
                </select>
            </div>
